...
def parse_args(parser):
    ...
    parser.add_argument('--num_epochs', type=int, default=60, help='num_epochs')
    ...
    parser.add_argument('--restart_data_batches',type=str, default="False", help= 'restart_data_batches')
